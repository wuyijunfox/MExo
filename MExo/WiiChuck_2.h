...
class WiiChuck {
    ...
    public:
        ...
        void begin() 
        {
            // Wire.begin();    // Moved to Main setup in order to accomadate the I2Cdev.h of MExo
            // Wire.setClock(400000); // 400kHz I2C clock. Helps to fix the I2C self-block a lot.
            ...
            Wire.endTransmission();
            //update();     ///////////////////////////////////// Useless, commented for test       
            for (i = 0; i<3;i++) {
                angles[i] = 0;
            }
